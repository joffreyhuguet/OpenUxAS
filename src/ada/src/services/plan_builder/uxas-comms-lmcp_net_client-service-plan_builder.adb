...
package body UxAS.Comms.LMCP_Net_Client.Service.Plan_Builder is
   ...
   begin
      declare
         Overrides_List : SpeedAltPair_Ref_Deque;
      begin
         for Override of Overrides.all loop
            SpeedAltPair_Lists.Append (Overrides_List, Override.all);
         end loop;
   ...
   begin
      Process_Task_Assignment_Summary (This.State, This.Config, This.Mailbox, Msg, Should_Terminate);
   ...
   is
   begin
      Process_Task_Implementation_Response (This.State, This.Config, This.Mailbox, Msg);
   ...
   is
      ...
      Tasks : TaskAssignment_Ref_Deque;
